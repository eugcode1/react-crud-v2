...
class ReadProductsComponent extends React.Component {
    constructor(props) {
        ...
        this.goToInputPage = this.goToInputPage.bind(this);
        this.pageChanged = this.pageChanged.bind(this);
        this.sortChanged = this.sortChanged.bind(this);
        this.sortClass = this.sortClass.bind(this);
        this.searchTerm = this.sortClass.bind(this);
        this.onInputPageChange = this.onInputPageChange.bind(this);
        this.toggleOne = this.toggleOne.bind(this);
        this.toggleAll = this.toggleAll.bind(this);
        this.deleteSelected = this.deleteSelected.bind(this);
        this.itemPerPageChanged = this.itemPerPageChanged.bind(this);
    }
    ...
    componentDidMount() {
        ...
        this._mounted = true;//replace isMounted
    }
    ...
    //get different items on each page
    sortClass(filterName){//error on orderBy
